...
In rc2 we changed the frontend/cart/cart.twig template to distinguish between having one or multiple items in the cart, to improve the linguistics of the translations. 
