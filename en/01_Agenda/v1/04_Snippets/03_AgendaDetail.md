...
| allowedRequestKeys | Comma-separated list of request keys, that could be used to filter the displayed event. Defaults to all allowed.                                                                                   | -                      |
...
| where              | JSON encoded xPDO where clause to filter the event.                                                                                                                                                | -                      |
